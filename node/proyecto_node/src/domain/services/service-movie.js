// Find, new, create, servir lo que se ejecute. Generador de respuestas al usario
// Necesitamos magic para el response service + enum para indicar los códgos de
// estados + get old + create
...
// Dispara la función asincrona del orm
// Aislamos el controlador de la respuesta
// Definimos por efecto
...
exports.Create = async (req, res) => {
  ...
  try {
    ...
    response = await magic.ResponseService(status, errorcode, message, data);
    // Lo que se visualiza en insomnia
    return res.status(statuscode).send(response);
  } catch (err) {
    // magic.LogDanger("error: ", error);
    // sustituye el console.log, utilizando la función 
